...
void	testAddNumberException() {
	std::cout << YELLOW BOLD << "\n - - - - TEST 3: Testing the addNumber exception - - - - - \n" << RESET << std::endl;
...
void	testShortLongException() {
	std::cout << YELLOW BOLD << "\n - - - - TEST 4: Testing the shortest and longest span exception - - - - - \n" << RESET << std::endl;
...
void	testFillFunction() {
	std::cout << YELLOW BOLD << "\n - - - - TEST 5: Testing filling vector using a range of iterators - - - - - \n" << RESET << std::endl;
	...
	a.addNumber(2);
	a.addNumber(3);
	std::cout << "BEFORE FILL FUNCTION" <<std::endl;
	a.print();
	...
	std::cout << "AFTER FILL FUNCTION" <<std::endl;
...
void	testManyNumbers() {
	std::cout << YELLOW BOLD << "\n - - - - TEST 6: Testing span with many numbers - - - - - \n" << RESET << std::endl;
	Span a(10001);
